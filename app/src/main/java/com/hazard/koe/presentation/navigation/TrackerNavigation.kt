package com.hazard.koe.presentation.navigation
...
import com.hazard.koe.MainActivity
import com.hazard.koe.presentation.accounts.AccountsScreen
import com.hazard.koe.presentation.accounts.accountdetail.AccountDetailScreen
import com.hazard.koe.presentation.accounts.addaccount.AddAccountScreen
import com.hazard.koe.presentation.addtransaction.AddTransactionViewModel
import com.hazard.koe.presentation.addtransaction.AmountEntryScreen
import com.hazard.koe.presentation.addtransaction.components.DescriptionSheet
import com.hazard.koe.presentation.categories.CategoriesScreen
...
import com.hazard.koe.presentation.loans.detail.CasualLoanDetailScreen
import com.hazard.koe.presentation.loans.detail.CasualLoanDetailViewModel
import com.hazard.koe.presentation.loans.detail.FormalLoanDetailScreen
import com.hazard.koe.presentation.loans.detail.FormalLoanDetailViewModel
import com.hazard.koe.presentation.settings.yapesetup.screens.YapeSetupAccountScreen
import com.hazard.koe.presentation.settings.yapesetup.screens.YapeSetupIntroScreen
import com.hazard.koe.presentation.settings.yapesetup.screens.YapeSetupPermissionScreen
import com.hazard.koe.presentation.settings.yapesetup.screens.YapeStatusScreen
import com.hazard.koe.presentation.subscriptions.SubscriptionViewModel
import com.hazard.koe.presentation.subscriptions.detail.SubscriptionDetailScreen
import com.hazard.koe.presentation.subscriptions.picker.SubscriptionPickerScreen
...
import com.hazard.koe.presentation.voice.voicetransaction.VoiceTransactionCreationResult
            ...
            NavHost(
                ...
                composable("voice_transaction") {
                    VoiceTransactionScreen(
                        onNavigateBack = { navController.popBackStack() },
                        onTransactionCreated = { creationResult ->
                            pendingVoiceUndoEvent = creationResult
                            navController.popBackStack(TrackerTab.Home.route, inclusive = false)
                        },
